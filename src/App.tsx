...
function Logo({ footer = false }: LogoProps) {
  ...
  return <img src={LOGO_SRC} alt="Octalumen" className={footer ? "h-14 w-auto object-contain" : "h-14 w-auto object-contain sm:h-16"} loading={footer ? "lazy" : "eager"} onError={() => setLogoError(true)} />;
}
function Header() {
